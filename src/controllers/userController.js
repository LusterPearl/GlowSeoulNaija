...
class UserController {
  ...
  // 2. Get authenticated user profile - GET /profile
  ...
  // 3. Update authenticated user profile - PUT /profile
  ...
  // 4. Upload profile picture - POST /profile/picture
  ...
  // 5. Delete authenticated user profile - DELETE /profile
  ...
  // 6. Delete a specific user profile (Admin only) - DELETE /profiles/:id
