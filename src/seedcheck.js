const products = [
    ...
    { "name": "Hydrating Sheet Mask", "description": "Sheet mask for hydration.", "price": 300100, "quantity": 200, "category": "Skincare - Sheet Masks" },
    ...
    // Makeup
    { "name": "Lightweight BB Cream", "description": "Lightweight coverage cream.", "price": 1500000, "quantity": 150, "category": "Makeup - BB Creams/CC Creams" },
    { "name": "CC Cream", "description": "Color correcting cream for a flawless look.", "price": 1700000, "quantity": 100, "category": "Makeup - BB Creams/CC Creams" },
    { "name": "Dewy Finish Cushion Foundation", "description": "Cushion compact for a dewy finish.", "price": 3000000, "quantity": 80, "category": "Makeup - Cushion Foundations" },
    { "name": "Long-lasting Lip Tint", "description": "Tinted lip color that lasts.", "price": 1200000, "quantity": 200, "category": "Makeup - Lip Tints" },
    { "name": "Gradient Lip Tint", "description": "Lip tint for a gradient effect.", "price": 1400000, "quantity": 150, "category": "Makeup - Lip Tints" },
    { "name": "Shimmery Eyeshadow", "description": "Eyeshadow with a shimmer finish.", "price": 190000, "quantity": 120, "category": "Makeup - Eyeshadows" },
    { "name": "Neutral Palette Eyeshadow", "description": "Palette with neutral tones.", "price": 2400000, "quantity": 90, "category": "Makeup - Eyeshadows" },
    { "name": "Lengthening Mascara", "description": "Mascara that lengthens lashes.", "price": 1600000, "quantity": 180, "category": "Makeup - Mascaras" },
    ...
    { "name": "Cream Blush", "description": "Cream blush for a natural flush.", "price": 1300000, "quantity": 160, "category": "Makeup - Blushes" },
    { "name": "Powder Blush", "description": "Powder blush for easy application.", "price": 1100000, "quantity": 150, "category": "Makeup - Blushes" },
    { "name": "Eyebrow Pencil", "description": "Pencil for defining brows.", "price": 9000000, "quantity": 200, "category": "Makeup - Eyebrow Products" },
    ...
    // Bodycare
    { "name": "Brightening Scrub", "description": "Scrub that brightens skin.", "price": 17000, "quantity": 140, "category": "Bodycare - Body Scrubs" },
    { "name": "Hydrating Body Lotion", "description": "Lotion for hydration.", "price": 18000, "quantity": 140, "category": "Bodycare - Body Lotions" },
    { "name": "Exfoliating Body Scrub", "description": "A scrub that exfoliates the skin.", "price": 19000, "quantity": 130, "category": "Bodycare - Body Scrubs" },
    { "name": "Moisturizing Body Wash", "description": "Body wash for hydration.", "price": 12000, "quantity": 160, "category": "Bodycare - Body Washes" },
    { "name": "Firming Body Lotion", "description": "Lotion that firms skin.", "price": 20000, "quantity": 130, "category": "Bodycare - Body Lotions" },
    { "name": "Gentle Body Wash", "description": "Gentle cleanser for the body.", "price": 10000, "quantity": 170, "category": "Bodycare - Body Washes" },
    ...
    { "name": "Rose Quartz Roller", "description": "Facial roller made of rose quartz.", "price": 70099, "quantity": 70, "category": "Beauty Tools - Facial Rollers" }
];
...
db.products.insertMany([
    ...
    { "name": "Firming Body Lotion", "description": "Lotion that firms skin.", "price": 20000, "quantity": 130, "category": "Bodycare - Body Lotions" },
    { "name": "Gentle Body Wash", "description": "Gentle cleanser for the body.", "price": 10000, "quantity": 170, "category": "Bodycare - Body Washes" },
    { "name": "Relaxing Bath Soak", "description": "Bath soak for relaxation.", "price": 15000, "quantity": 150, "category": "Bodycare - Bath Soaks" },
