...
const seedProducts = async () => {
  const products = [
    ...
    {
      name: 'Manual Cleansing Brush', description: 'Manual brush for cleansing.', price: 150000, quantity: 100, category: 'Beauty Tools - Cleansing Brushes',
    },
    {
      name: 'Full Set Makeup Brushes', description: 'Complete set of makeup brushes.', price: 450000, quantity: 50, category: 'Beauty Tools - Makeup Brushes',
    },
    {
      name: 'Blending Sponge', description: 'Sponge for blending makeup.', price: 800099, quantity: 200, category: 'Beauty Tools - Makeup Tools',
    },
  ];
